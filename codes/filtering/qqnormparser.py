...
dir = args.qqnorminput[0:args.qqnorminput.rfind('/')]            
location_name = dir + '/Gene_location' + CHR
expression_name = dir + '/Gene_expression' + CHR
with open(location_name, 'wb') as output_file:
    #write out
    for line in gene_loc:
        output_file.write((line + '\n').encode('utf-8'))

with open(expression_name, 'wb') as output_file:
    #write out
